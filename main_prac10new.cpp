...
//Práctica: 10
//Versión VS: 2017
//Instrucciones: Se presenta un objeto diferente al de clase, en
//este caso se trata de una nave espacial, la cual se desplaza
//por todo el camino y una vez que esta llega al final, rota 180
//grados sobre su eje para dar la ilusión de que da la vuelta y
//va de regreso sobre el mismo camino.
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(0, 500, movNave);
	glRotatef(rotacionNave, 0.0, 1.0, 0.0);

	//Pongo aquí la nave
	nave.GLrender(NULL, _SHADED, 1.0);
...
void animacion()
{
	...
	if (g_fanimacion)
	{
		if (avanza)
		{
			...
			{
				avanza = false;
				rotacionNave = (rotacionNave - 180) % 360;
			}
		}
		else
		{
