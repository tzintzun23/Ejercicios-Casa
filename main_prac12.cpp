...
//Práctica: 12
//Versión VS: 2017
//Instrucciones: Para el ejercicio de casa, se realizó la animación
//de un coche el cual se va elevando en parte de su recorrido, para
//después permanecer constante en cierta altura y posteriormente ir
//descendiendo a su altura original (al nivel del suelo).
